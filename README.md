...
|---|---|---|---|---|---|---|
| [Betfair Exchange](https://www.betfair.com/exchange) | ✓ | ✓ | partial | odds ticks+book | — | No compliant free path: the free Delayed App Key omits totalMatched and the GBP 499 Live key forbids read-only data collection. Nothing is published either — Flutter's filings never size the Exchange. Closest proxies are sector-wide, covering all licensed exchanges: GB betting-exchange GGY of GBP 101.4m (FY24-25, commission not volume) and Italian ADM turnover of EUR 3.0bn (2024). |
